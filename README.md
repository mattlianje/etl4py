...
A lightweight, zero-dependency library for writing beautiful ✨🍰, type-safe dataflows in Python 3.7+
Works with **_any_** framework, **_any_** place. From raspberry-pi, to massive multicore clusters.
