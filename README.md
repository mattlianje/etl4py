...
A lightweight, single-file + zero-dependency DSL for writing beautiful ✨🍰, type-safe Python dataflows that run **_anywhere_**: from raspberry-pi, to massive clusters.
